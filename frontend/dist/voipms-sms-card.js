...
let VoipmsSmsCard = class VoipmsSmsCard extends i {
    constructor() {
        super(...arguments);
        this._config = null;
        this._did = "";
    ...
    async _handleSend() {
        if (!this.hass || !this._to.trim() || !this._message.trim())
            return;
    ...
    _renderStatus() {
        if (this._sendState === "idle")
            return A;
        if (this._sendState === "sending") {
            return b `<span class="status">Sending…</span>`;
        }
        if (this._sendState === "success") {
            return b `<span class="status success">Sent</span>`;
        }
        return b `<span class="status error"
    ...
    render() {
        ...
        const canSend = this._sendState !== "sending" &&
      ...
      <ha-card>
        ...
        <ha-textfield
          ...
          @input=${(e) => (this._did = e.target.value)}
        ></ha-textfield>
        <ha-textfield
          label="To"
          .value=${this._to}
          placeholder="recipient number"
          @input=${(e) => (this._to = e.target.value)}
        ></ha-textfield>
        <textarea
          placeholder="Message"
          .value=${this._message}
...
__decorate([
    n({ attribute: false })
], VoipmsSmsCard.prototype, "hass", void 0);
__decorate([
    r()
], VoipmsSmsCard.prototype, "_config", void 0);
__decorate([
    r()
], VoipmsSmsCard.prototype, "_did", void 0);
__decorate([
    r()
], VoipmsSmsCard.prototype, "_to", void 0);
__decorate([
    r()
], VoipmsSmsCard.prototype, "_message", void 0);
__decorate([
    r()
], VoipmsSmsCard.prototype, "_sendState", void 0);
__decorate([
    r()
], VoipmsSmsCard.prototype, "_errorMessage", void 0);
VoipmsSmsCard = __decorate([
    t("voipms-sms-card")
], VoipmsSmsCard);
