...
def main():
    ...
    try:
        ...
        req = urllib.request.Request("https://api.github.com/repos/hacs/integration/releases/latest")
        with urllib.request.urlopen(req) as response:
            data = json.loads(response.read())
            zip_url = next(asset["browser_download_url"] for asset in data["assets"] if asset["name"] == "hacs.zip")
