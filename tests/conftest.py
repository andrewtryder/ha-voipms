...
def mock_zeep_client():
    ...
    with patch("custom_components.voipms_custom.config_flow.zeep.Client") as mock_client_flow, \
         patch("custom_components.voipms_custom.coordinator.zeep.Client") as mock_client_coord, \
         patch("custom_components.voipms_custom.notify.zeep.Client") as mock_client_notify, \
         patch("custom_components.voipms_custom.__init__.zeep.Client") as mock_client_init:
        ...
        mock_instance.service.getBalance.return_value = {"status": "success", "balance": 15.50}
